function SnipcartScript() {
    return (
        <script id="snipcart-script" type="text/javascript" async defer dangerouslySetInnerHTML={{
            __html: `window.SnipcartSettings = {
                publicApiKey:
                  "${process.env.NEXT_PUBLIC_SNIPCART_TEST_API_KEY}",
